    ...
    def __init__(self, screensize, WCview):
        ...
        for y in range(amountgroundspritesy):
            for x in range(amountgroundspritesx):
                self.groundspritelist.append(Groundsprite((x, y), self.imagebank, WCview, int(self.spritesize)))
...
#make world
    world = World_infineon(screen.get_size(), player.WCview)

#create ground sprites
    # screensize=screen.get_size()
    # amountgroundspritesx = int(math.ceil(screensize[0]/world.spritesize)+1)
    # amountgroundspritesy = int(math.ceil(screensize[1]/world.spritesize)+1)
    # groundspritelist=[]
    # groundspritegroup = pygame.sprite.Group()
    # for y in range(amountgroundspritesy):
    #     for x in range(amountgroundspritesx):
    #         groundspritelist.append(Groundsprite((x, y), world.imagebank, player.WCview, int(world.spritesize)))
...
#mainloop
    ...
    while going:
        ...
        world.groundspritegroup.update(player, world.imagebank)
        ...
        #Draw Everything
        screen.blit(background, (0,0))
        world.groundspritegroup.draw(screen)

...
class Groundsprite(pygame.sprite.Sprite):
    ...
    def update(self, playerWC):
        self.rect.bottomleft = (self.origin[0] - playerWC[0] % self.spritesize, self.origin[1] + playerWC[1] % self.spritesize)
...
#create ground sprites
    ...
    #amountgroundsprites = amountgroundspritesx * amountgroundspritesy
    #amountgroundspritestuple = (amountgroundspritesx, amountgroundspritesy)
    groundspritelist=[]
...
#mainloop
    ...
    while going:
        ...
        groundspritegroup.update(player.WCview)

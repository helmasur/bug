...
class Groundsprite(pygame.sprite.Sprite):
    def __init__(self, pos, image, WCview, spritesize):
        pygame.sprite.Sprite.__init__(self) #call Sprite initializer
...
class World_2000():
    def __init__(self, screensize, WCview):
        ...
        self.sprite = Groundsprite((0,0), self.image, WCview, self.spritesize)
...
#make world
    world = World_2000(screen.get_size(), player.WCview)
